...
CREATE TABLE DEPARTMENT(
	DEPARTMENT_ID VARCHAR(2) NOT NULL PRIMARY KEY,
	DEDSCRPTION VARCHAR(45) NOT NULL,
)
GO
...
CREATE TABLE CITY(
	...
	DEPARTAMENT_ID VARCHAR(2) REFERENCES DEPARTMENT(DEPARTMENT_ID),
)
GO


CREATE TABLE DISTRIC(
	DISTRICT_ID VARCHAR(6) NOT NULL PRIMARY KEY,
	DESCRIPTION VARCHAR(45) NOT NULL,
	CITY_ID VARCHAR(4) REFERENCES CITY(CITY_ID),
	DEPARTMENT_ID VARCHAR(2) REFERENCES DEPARTMENT(DEPARTMENT_ID)
)
